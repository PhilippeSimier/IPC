...
int main(int argc, char *argv[])
{
	...
	memset(buffer, '\0', 255);
	printf("serveur UDP sur port 4444 attend une structure de type datePerso\n");
	...
	while(1==1){
	retour = recvfrom(fdSocket, &dateClient, sizeof(dateClient), 0, (struct sockaddr *) &adresseClient, &tailleClient);
